...
<div className="fd-steps">
  <div className="fd-step">
    ## Crear el comportamiento remoto [#1-crear-el-comportamiento-remoto]
  ...
  <div className="fd-step">
    ## Enviar la acción [#2-enviar-la-acción]
  ...
  <div className="fd-step">
    ## Elegir destinatarios [#3-elegir-destinatarios]
  ...
  <div className="fd-step">
    ## No mezclar acción y estado [#4-no-mezclar-acción-y-estado]
  ...
  <div className="fd-step">
    ## Acciones y múltiples canales [#6-acciones-y-múltiples-canales]
  ...
  <div className="fd-step">
    ## Cuándo usar cada mecanismo [#8-cuándo-usar-cada-mecanismo]
